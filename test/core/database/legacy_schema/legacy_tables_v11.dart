// Frozen schema snapshot for schemaVersion 10
// (TASK-030 complete — includes quote_vehicles).
// DO NOT update this file to follow production tables.dart.
//
// Used exclusively to open a genuine SQLite v10 database in
// migration tests before upgrading to AppDatabase schemaVersion 11+.
//
// Historical snapshot — intentionally frozen.
...
@DataClassName('LegacyTeamRoleRow')
@TableIndex(name: 'idx_team_roles_name', columns: {#name})
class LegacyTeamRoles extends Table {
  @override
...
@DataClassName('LegacyQuoteTeamMemberRow')
...
class LegacyQuoteTeamMembers extends Table {
  @override
  ...
  TextColumn get teamMemberId =>
      text().references(LegacyTeamMembers, #id, onDelete: KeyAction.restrict)();
  TextColumn get roleId =>
      text().references(LegacyTeamRoles, #id, onDelete: KeyAction.restrict)();
  IntColumn get dailyRate => integer()();
  TextColumn get notes => text().nullable()();
  IntColumn get createdAt => integer()();
  IntColumn get updatedAt => integer()();
...
/// Vehicle types (TASK-030 CP-B).
@DataClassName("LegacyVehicleTypeRow")
@TableIndex(name: "idx_vehicle_types_name", columns: {#name})
class LegacyVehicleTypes extends Table {
  @override
...
@DataClassName("LegacyVehicleRow")
...
class LegacyVehicles extends Table {
  @override
...
@DataClassName('LegacyQuoteVehicleRow')
...
class LegacyQuoteVehicles extends Table {
  @override
  ...
  TextColumn get vehicleId =>
      text().references(LegacyVehicles, #id, onDelete: KeyAction.restrict)();
...
@DataClassName('LegacyContractTemplateRow')
@TableIndex(name: 'idx_contract_templates_name', columns: {#name})
class LegacyContractTemplates extends Table {
  @override
...
@DataClassName('LegacyContractRow')
...
class LegacyContracts extends Table {
  @override
