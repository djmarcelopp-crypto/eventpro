// Cópia congelada do schema real da TASK-027 CP-F/G (schemaVersion 4),
// exatamente como definido em lib/core/database/tables.dart antes da
// TASK-028 CP-B (antes de `equipment_categories` / `equipment` existirem).
//
// Usada exclusivamente para gerar um banco SQLite v4 genuíno em
// test/core/database/equipment_migration_test.dart, permitindo testar a
// migração real 4 -> 5 (TASK-028 CP-B) contra um schema legado de fato.
//
