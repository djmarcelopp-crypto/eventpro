// Cópia congelada do schema real da TASK-028 CP-B/CP-C (schemaVersion 5),
// exatamente como definido em lib/core/database/tables.dart antes da
// TASK-028 CP-D (antes de `quote_equipment` existir).
//
// Usada exclusivamente para gerar um banco SQLite v5 genuíno em
// test/core/database/quote_equipment_migration_test.dart, permitindo testar a
// migração real 5 -> 6 (TASK-028 CP-D) contra um schema legado de fato.
//
