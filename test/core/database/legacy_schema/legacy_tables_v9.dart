// Frozen schema snapshot for schemaVersion 9
// (TASK-029 complete — includes quote_team_members).
// DO NOT update this file to follow production tables.dart.
//
// Used exclusively to open a genuine SQLite v8 database in
// migration tests before upgrading to AppDatabase schemaVersion 10+.
//
